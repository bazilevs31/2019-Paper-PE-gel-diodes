...
The template project on Overleaf contains:

 - rsc_art_sm.tex (the template with example text)
...
The following files need to be in the same folder as rsc_art_sm.tex for the example template to compile correctly:
